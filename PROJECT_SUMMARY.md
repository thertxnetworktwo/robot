...
3. Bot: "Detected Bangladesh (BD). Sending verification code..." then "The code sent to number +8801712345678"
4. User: `12345` (OTP)
5. Bot: "Session created! Pending approval..."
6. [System runs checks]
7. Bot: "Account approved! Balance added: $2.00"
